# Datasets for CD-Based Sensor Data Reconstruction

This folder contains the datasets required to run the CD-based reconstruction scripts.

## Molene Dataset

- The **Molene dataset** CSV file is included in this folder.  
- You can use it directly with `CD_Reconstruction_MoleneDataset.ipynb`.
